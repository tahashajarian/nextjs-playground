  ...
  return (
    <header className="">
      <div className="hidden lg:flex pt-2">
        ...
        <ul className="flex flex-row lg:mx-10 mx-5 justify-center items-center">
      ...
      <div className="lg:hidden flex">
        <div className="w-full flex flex-row justify-center items-center bg-white shadow-md h-12 fixed z-40">
          <span
            onClick={() => {
              setOpenMenu(true);
            }}
      ...
      {openMenu && (
        <div className="fixed z-50 bg-gray-400 bg-opacity-50 inset-0">
          <div className="absolute h-full bg-white flex flex-col items-center py-10 shadow-lg w-64">
            <span
